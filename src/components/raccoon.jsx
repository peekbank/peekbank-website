...
const SVG_VIEWPORT_DIM = 184.803;
...
const RaccoonEyes = () => {
  ...
  useEffect(() => {
    ...
    if (!leftPupil || !rightPupil || !leftHighlight || !rightHighlight || !svg)
      return;

    // Eye centers and constraints
    const leftEye = { cx: 59.52, cy: 109.735, maxDistance: 5.0 };
    const rightEye = { cx: 125.283, cy: 109.736, maxDistance: 5.0 };

    function setEyesLookingDown() {
      // Position pupils looking straight down
      const leftDownY = leftEye.cy + leftEye.maxDistance;
      const rightDownY = rightEye.cy + rightEye.maxDistance;
      
      leftPupil.setAttribute("cx", leftEye.cx);
      leftPupil.setAttribute("cy", leftDownY);
      rightPupil.setAttribute("cx", rightEye.cx);
      rightPupil.setAttribute("cy", rightDownY);

      // Update highlight positions
      const highlightOffset = 2;
      
      // Left highlight
      const leftHighlightX = leftEye.cx - highlightOffset;
      const leftHighlightY = leftDownY - highlightOffset;
      const leftPath = `M${leftHighlightX + 4.347},${
        leftHighlightY - 2.174
      }c0,2.754-2.526,2.174-2.174,2.174c-1.2,0-2.173-0.974-2.173-2.174c0-1.2,0.973-2.174,2.173-2.174C${
        leftHighlightX + 3.374
      },${leftHighlightY - 4.347},${leftHighlightX + 4.347},${leftHighlightY - 3.374},${
        leftHighlightX + 4.347
      },${leftHighlightY - 2.174}z`;
      leftHighlight.setAttribute("d", leftPath);

      // Right highlight  
      const rightHighlightX = rightEye.cx - highlightOffset;
      const rightHighlightY = rightDownY - highlightOffset;
      const rightPath = `M${rightHighlightX + 4.347},${
        rightHighlightY - 2.174
      }c0,2.754-2.526,2.174-2.174,2.174c-1.2,0-2.173-0.974-2.173-2.174c0-1.2,0.973-2.174,2.173-2.174C${
        rightHighlightX + 3.374
      },${rightHighlightY - 4.347},${rightHighlightX + 4.347},${rightHighlightY - 3.374},${
        rightHighlightX + 4.347
      },${rightHighlightY - 2.174}z`;
  ...
  return (
    <div
      className="raccoon-container w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48"
      style={{
        margin: "0 auto",
        cursor: isSmallScreen ? "default" : "none",
      }}
    >
      <svg
        ref={svgRef}
        ...
        x="0px"
        y="0px"
        viewBox="0 0 184.803 184.803"
        style={{
          enableBackground: "new 0 0 184.803 184.803",
          width: "100%",
          height: "auto",
          display: "block",
        }}
      ...
      >
        <g>
          <g>
            <path
              style={{ fill: "#E9E2D8" }}
              d="M63.389,69.93c-0.613,1.587-1.513,2.998-2.698,4.184c-7.332,7.324-23.146,3.591-36.487-8.197
            ...
            <path
              style={{ fill: "#1D1814" }}
              d="M50.431,68.331c-4.841,0-13.594-3.1-22.331-11.837c-5.477-5.478-9.535-11.934-11.132-17.714
          ...
          <path
            style={{ fill: "#7D746D" }}
            d="M92.401,37.912v126.74c-0.626,0-1.247-0.007-1.867-0.014c-1.301-0.02-2.596-0.055-3.884-0.116
          ...
          <path
            style={{ fill: "#E9E2D8" }}
            d="M92.401,143.176c0,1.888-0.041,3.761-0.129,5.621c-0.15,3.481-0.45,6.909-0.886,10.262
          ...
          <path
            style={{ fill: "#1D1814" }}
            d="M55.145,149.274c-2.664,2.664-5.396,5.144-8.149,7.406c-2.064-0.75-4.082-1.554-6.044-2.412
              c-0.572-0.246-1.131-0.498-1.696-0.75c-0.382-0.17-0.763-0.348-1.145-0.531c-7.931-3.693-14.97-8.149-20.761-13.109
              c-0.92-0.79-1.806-1.588-2.664-2.405c-2.214-2.105-4.218-4.299-5.976-6.555c-0.238-0.3-0.463-0.6-0.688-0.906
          ...
          <g>
            ...
            <path
              ...
              style={{ fill: "#FFFFFF" }}
              d="M63.867,107.561c0,2.754-2.526,2.174-2.174,2.174c-1.2,0-2.173-0.974-2.173-2.174c0-1.2,0.973-2.174,2.173-2.174C62.894,105.388,63.867,106.361,63.867,107.561z"
            />
          </g>

          <g>
            <ellipse
              transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 220.0761 189.1786)"
              style={{ fill: "#E9E2D8" }}
              cx="149.218"
              cy="49.011"
              rx="20.124"
            ...
            <path
              style={{ fill: "#1D1814" }}
              d="M134.372,68.331c4.842,0,13.594-3.1,22.331-11.836c5.478-5.478,9.535-11.934,11.133-17.714
          ...
          <path
            style={{ fill: "#7D746D" }}
            d="M184.78,109.101c-0.184,5.199-1.703,10.31-4.333,15.194c-0.375,0.688-0.77,1.377-1.192,2.058
          ...
          <path
            style={{ fill: "#1D1814" }}
            d="M129.658,149.274c2.665,2.664,5.396,5.145,8.149,7.406c2.064-0.749,4.081-1.553,6.044-2.412
          ...
          <g>
            ...
            <path
              ...
              style={{ fill: "#FFFFFF" }}
              d="M120.936,107.562c0,2.754,2.526,2.174,2.173,2.174c1.201,0,2.174-0.974,2.174-2.174c0-1.201-0.973-2.174-2.174-2.174C121.909,105.389,120.936,106.361,120.936,107.562z"
            />
          </g>

          <path
            style={{ fill: "#E9E2D8" }}
            d="M103.971,135.526v28.188c-0.477,0.087-0.961,0.162-1.445,0.225c-0.784,0.113-1.567,0.2-2.357,0.288
          ...
          <path
            style={{ fill: "#1D1814" }}
            d="M92.401,129.532L92.401,129.532c-8.067,0.001-14.602-0.958-14.602,5.147
          ...
          <path
            style={{ fill: "#43423E" }}
            d="M92.406,159.619c-3.655,0-7.064-1.965-8.898-5.128c-0.554-0.955-0.228-2.179,0.728-2.733
          ...
          <path
            ...
            d="M92.401,37.912v126.74c-0.626,0-1.247-0.007-1.867-0.014
